...
def planning(goal):
    ...
    desired_position_.x = goal.target_pose_robot.pose.position.x
    desired_position_.y = goal.target_pose_robot.pose.position.y
...
def main():
    ...
    act_s = actionlib.SimpleActionServer(
        '/robot/reaching_goal_robot', exp_assignment2.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
