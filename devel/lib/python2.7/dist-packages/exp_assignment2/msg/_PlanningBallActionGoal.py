...
"""autogenerated by genpy from exp_assignment2/PlanningBallActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PlanningBallActionGoal(genpy.Message):
  _md5sum = "660d6895a1b9a16dce51fbdd9a64a56b"
  _type = "exp_assignment2/PlanningBallActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','exp_assignment2/PlanningBallGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanningBallActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = exp_assignment2.msg.PlanningBallGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = exp_assignment2.msg.PlanningBallGoal()
