...
"""autogenerated by genpy from exp_assignment2/PlanningBallActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanningBallActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "exp_assignment2/PlanningBallActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','exp_assignment2/PlanningBallResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanningBallActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = exp_assignment2.msg.PlanningBallResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = exp_assignment2.msg.PlanningBallResult()
