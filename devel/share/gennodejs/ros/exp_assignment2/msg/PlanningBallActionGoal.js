...
class PlanningBallActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new PlanningBallGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanningBallGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlanningBallGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanningBallActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PlanningBallGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PlanningBallGoal()
    }
...
module.exports = PlanningBallActionGoal;
